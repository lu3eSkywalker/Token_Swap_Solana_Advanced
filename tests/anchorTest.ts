...
describe("Test", () => {
  ...
  it("initializes a liquidity account", async () => {
    ...
    console.log("This is the fucking user liquidity PDA: ", userPDALiquidity.toBase58());
  ...
  it("adds liquidity to the liquidity pool", async () => {
    ...
    console.log("This is the Fucking Mint: ", mint.toBase58());
  ...
  it("Swap Token B for Token A", async () => {
    ...
    const minExpectedOutput = expectedOutput.muln(slippageMultiplier * 1000).divn(10000);
